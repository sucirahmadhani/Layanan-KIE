...
<div class="bg-gray-100 flex justify-center items-center h-auto p-5">
    ...
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm ">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">
            Layanan Komunikasi Informasi dan Edukasi yang anda daftarkan belum terlaksana.
        </h5>
        <p class="mb-3 font-normal text-gray-800">
            Silakan mendaftar kegiatan layanan KIE baru dengan menekan tombol di bawah ini.
        </p>
    ...
    @else
    <div class="w-full max-w-10xl mt-0 space-y-3 bg-white rounded-lg p-6 shadow-md mb-6">
            ...
            <table class="w-full text-sm text-left rtl:text-right">
                <thead class="text-xs text-gray-700 uppercase bg-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Jenis KIE</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b border-gray-200">
                        ...
                        <td class="px-6 py-4">{{ $layanan->jenis_layanan }}</td>
                        <td class="px-6 py-4">{{ $layanan->nama_instansi }}</td>
                        <td class="px-6 py-4">
                            @foreach($layanan->topik as $topik)
                                <span class="bg-blue-200 text-blue-900 px-2 py-1 rounded-md mb-2 inline-block">{{ $topik->judul }}</span>
                            @endforeach
                        </td>
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('riwayat.detail', $layanan->layanan_id) }}"
